...
def procedure_handler(hermes, intent_message):
    ...
    hermes.publish_continue_session(intent_message.session_id, sentence, [INTENT_SHOW, INTENT_RANDOM, INTENT_CANCEL])

with Hermes(MQTT_ADDR) as h:
    h.subscribe_intent(INTENT_SHOW, procedure_handler)